...
namespace OOBootCampTest
{
    public class MarkdownReportTests
    {
        ...
        public void should_report_when_manager_manages_nothing()
        {
            ...
            parkingManager.ParkingReport.ToString("markdown").Should().Be("# M 0 0");
        }
        ...
        public void should_report_when_manager_manages_one_parking_lot()
        {
            ...
            parkingManager.ParkingReport.ToString("markdown").Should().Be(
                "# M 1 2" + NewLine +
                "* P 1 2");
        }
        ...
        public void should_report_when_manager_manages_one_parking_lot_and_different_parking_boys()
        {
            ...
            var actualReportText = parkingManager.ParkingReport.ToString("markdown");
